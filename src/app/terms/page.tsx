...
export default function page() {
  return (
    <div className="max-w-3xl mx-auto px-5 py-8 bg-white rounded-lg shadow-md mt-6">
      ...
      <h2 className="text-3xl mt-5">Interpretation and Definitions</h2>
      <h3 className="text-2xl my-5">Interpretation</h3>
      <p>
      ...
      <h3 className="text-2xl my-5">Definitions</h3>
      ...
      <ul className="list-disc pl-5">
        ...
        <li>
          <p>
            ...
            this Agreement) refers to KeyLet.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to KeyLet, accessible from{" "}
            <a
              href="https://keylet.co.in/"
      ...
      <h2 className="text-3xl mt-5">Acknowledgment</h2>
      <p>
      ...
      <h2 className="text-3xl mt-5">Termination</h2>
      <p>
      ...
      <h2 className="text-3xl mt-5">Limitation of Liability</h2>
      <p>
      ...
      <h2 className="text-3xl mt-5">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h2>
      <p>
      ...
      <h2 className="text-3xl mt-5">Disputes Resolution</h2>
      <p>
      ...
      <h2 className="text-3xl mt-5">For European Union (EU) Users</h2>
      <p>
        If You are a European Union consumer, you will benefit from any
        mandatory provisions of the law of the country in which You are
        resident.
      </p>
      <h2 className="text-3xl mt-5">United States Legal Compliance</h2>
      <p>
      ...
      <h2 className="text-3xl mt-5">Severability and Waiver</h2>
      <h3 className="text-2xl my-5">Severability</h3>
      <p>
      ...
      <h3 className="text-2xl my-5">Waiver</h3>
      <p>
      ...
      <h2 className="text-3xl mt-5">Translation Interpretation</h2>
      <p>
      ...
      <h2 className="text-3xl mt-5">Changes to These Terms and Conditions</h2>
      <p>
      ...
      <ul className="list-disc pl-5">
        <li>
          ...
          <a
            href="https://keylet.co.in/contact/"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://keylet.co.in/contact/
          </a>
        </li>
      </ul>
    </div>
