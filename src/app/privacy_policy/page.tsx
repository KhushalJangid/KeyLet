...
export default function page() {
  return (
    <div className="max-w-3xl mx-auto px-5 py-8 bg-white rounded-lg shadow-md mt-6">
      ...
      <h2 className="text-3xl mt-5">Collecting and Using Your Personal Data</h2>
      <h3 className="text-2xl my-5">Types of Data Collected</h3>
      <h4>Personal Data</h4>
      <p>
      ...
      <h3 className="text-2xl my-5">Use of Your Personal Data</h3>
      ...
      <h3 className="text-2xl my-5">Retention of Your Personal Data</h3>
      <p>
      ...
      <h3 className="text-2xl my-5">Transfer of Your Personal Data</h3>
      <p>
      ...
      <h3 className="text-2xl my-5">Delete Your Personal Data</h3>
      <p>
      ...
      <h3 className="text-2xl my-5">Disclosure of Your Personal Data</h3>
      ...
      <h3 className="text-2xl my-5">Security of Your Personal Data</h3>
      <p>
      ...
      <h2 className="text-3xl mt-5">Children&apos;s Privacy</h2>
      <p>
      ...
      <h2 className="text-3xl mt-5">Changes to this Privacy Policy</h2>
      <p>
